...
class TransactionSyntaxError implements ValidationError {
  ...
  static InvalidUpdateProposal invalidUpdateProposal(
          List<Value_UpdateProposal> outs) =>
      InvalidUpdateProposal(outs);
...
class InvalidUpdateProposal extends TransactionSyntaxError {
  InvalidUpdateProposal(List<Value_UpdateProposal> outs)
      : super(TransactionSyntaxErrorType.invalidUpdateProposal, outs);
}
