...
class Proposer {
  ...
  static Proposition heightProposer(String chain, Int64 min, Int64 max) =>
      Proposition()
        ..heightRange =
            Proposition_HeightRange(chain: chain, min: min, max: max);
  ...
  static Proposition lessThanProposer(String location, Int128 compareTo) =>
      Proposition()
        ..lessThan =
            Proposition_LessThan(location: location, compareTo: compareTo);
  ...
  static Proposition equalToProposer(String location, Int128 compareTo) =>
      Proposition()
        ..equalTo =
            Proposition_EqualTo(location: location, compareTo: compareTo);

  /// Returns a [Proposition] with the [Proposition_Threshold] field set using the provided [challenges] and [threshold].
  static Proposition thresholdProposer(
          List<Proposition> challenges, int threshold) =>
      Proposition()
        ..threshold =
