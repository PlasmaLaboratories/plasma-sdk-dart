...
import 'package:plasma_sdk/src/utils/helpers.dart';
import 'package:protobuf/protobuf.dart';
import 'package:plasma_protobuf/plasma_protobuf.dart';
import 'package:plasma_sdk/src/quivr/runtime/quivr_runtime_error.dart' as quivr;
import 'package:plasma_sdk/src/quivr/runtime/quivr_runtime_error.dart';
import 'package:plasma_sdk/src/sdk/validation/transaction_authorization_error.dart';
...
main() {
  ...
  group('Credentialler Interpreter Spec', () {
    test('prove: other fields on transaction are preserved', () {
      final iotxEvent = txFull.datum.event.deepCopy()
        ..groupPolicies.replaceAll([mockGroupPolicy])
        ..seriesPolicies.replaceAll([mockSeriesPolicy])
