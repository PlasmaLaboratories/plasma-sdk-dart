...
void main() {
  group('ContainsSignable', () {
    test('IoTransaction.signable should return the same bytes as IoTransaction.immutable minus the Proofs', () {
      ...
      final emptyAttestation =
          Attestation(predicate: inPredicateLockFullAttestation.rebuild((p0) => p0.responses.clear()));
      ...
      expect(signableFull.length, equals(immutableFull.length - proofsImmutableSize));
