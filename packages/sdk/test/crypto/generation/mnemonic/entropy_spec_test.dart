...
import 'package:plasma_sdk/src/crypto/crypto.dart';
...
main() {
  group('Entropy Spec Test Vectors', () {
    ...
    test('Entropy can be generated and results in valid mnemonic strings',
        () async {
    ...
    test(
      ...
      for (final mnemonicSize in Generators.mnemonicSizes) {
        ...
        final entropy2 =
            await Entropy.fromMnemonicString(entropy2String.right!.join(' '));
