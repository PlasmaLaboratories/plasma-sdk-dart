...
import 'package:plasma_sdk/src/crypto/encryption/cipher/aes.dart';
import 'package:plasma_sdk/src/crypto/encryption/kdf/scrypt.dart';
import 'package:plasma_sdk/src/crypto/encryption/mac.dart';
...
void main() {
  group('Vault store Spec', () {
    VaultStore generateVaultStore(
        Uint8List sensitiveInformation, Uint8List password) {
    ...
    test('Verify decodeCipher returns InvalidMac with a different password',
      ...
      final decoded = VaultStore.decodeCipher(
          vaultStore, 'this is a different password'.toCodeUnitUint8List());
